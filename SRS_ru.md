...
Вид приложения имеет в начале [главное окно](https://github.com/MatPLay/SIFTRITPO/blob/main/Mockups/main_window.jpg), в котором содержатся переходы на все остальные окна и элементы графиского интерфейса пользователя: 
1. [диалоговое окно открытия файла](https://github.com/MatPLay/SIFTRITPO/blob/main/Mockups/open_window.png) (системное окно, предоставляет доступ к файловой системе для поиска нужного файла).
2. [управление цветом картинки для видео](https://github.com/MatPLay/SIFTRITPO/blob/main/Mockups/colour_opts.jpg) (управляет уровнями яркости, контрастности, оттенка и насыщенности изображения).
